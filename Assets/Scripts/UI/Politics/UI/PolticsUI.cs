...
public class PolticsUI : MonoBehaviour
{
    ...
    public void RefreshUI()
    {
        ...
        _aboutCountryText.text = @$"Âûáîðû: {UtilsPoliticsUI.ElectionTypeToString(_country.Politics.ElectionsType)}
Ôîðìà ïðàâëåíèÿ: {UtilsPoliticsUI.FormOfGovernmentToString(_country.Politics.FormGovernment)}
Èäåàëîãèÿ: {UtilsPoliticsUI.IdeologyToString(_country.Politics.CountryIdeology)}";
