...
public class PolticsUI : MonoBehaviour
{
    ...
    public void RefreshUI()
    {
        ...
        _aboutCountryText.text = @$"¬˚·Ó˚: {UtilsPoliticsUI.ElectionTypeToString(_country.Politics.ElectionsType)}
»‰Â‡ÎÓ„Ëˇ: {UtilsPoliticsUI.IdeologyToString(_country.Politics.CountryIdeology)}";
    ...
    private void UpdateFocusExecuteView()
    {
        ...
        {
            _executionFocusName.text = "Õ‡Ô‡‚ÎÂÌËÂ ÌÂ ‚˚·‡ÌÓ";
    ...
    private void AddLawsMenus()
    {
        ...
        var economicLawChangeData = new ChangeLawData(
            ...
            _country.Politics.EconomicsLaws, "›ÍÓÌÓÏËÍ‡");
        ...
        var conscriptionLawChangeData = new ChangeLawData(
            ...
            _country.Politics.—onscriptionLaws, "œËÁ˚‚");
